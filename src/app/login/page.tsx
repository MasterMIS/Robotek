  ...
  return (
    <div className="min-h-screen bg-[#FFF9E6] flex items-center justify-center p-4 font-sans selection:bg-[#CE2029] selection:text-white">
      ...
      <div className="w-full max-w-5xl h-[640px] bg-white rounded-[60px] shadow-[0_50px_120px_-30px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col lg:flex-row relative">
        ...
        {/* Right Pane - Form */}
        <div className="flex-1 bg-white p-10 md:p-14 lg:p-20 flex flex-col justify-start pt-12 lg:pt-16 relative z-20">
          <div className="max-w-md w-full mx-auto relative z-30">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-400 font-bold text-[10px] uppercase tracking-[0.4em]">Name of Confidence</p>
            </div>
