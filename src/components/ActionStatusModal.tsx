  ...
  return (
    <div className="fixed inset-0 z-[12000] flex items-center justify-center p-4">
      ...
      <div 
        ...
        className="relative bg-white dark:bg-navy-900 rounded-3xl shadow-2xl p-8 w-full max-w-[280px] text-center animate-in fade-in zoom-in duration-300 border dark:border-navy-700"
      >
