...
export default function MessageBubble({ message, isOwn, showTail = true, onImageClick, onForwardClick, onDeleteClick }: MessageBubbleProps) {
        ...
        <div className={`text-[10px] text-right flex items-center justify-end gap-2 ${
          ...
          {isOwn && onDeleteClick && (
            <button
              ...
              className="p-0.5 rounded-md hover:bg-black/10 transition-colors text-white/80 hover:text-red-300"
